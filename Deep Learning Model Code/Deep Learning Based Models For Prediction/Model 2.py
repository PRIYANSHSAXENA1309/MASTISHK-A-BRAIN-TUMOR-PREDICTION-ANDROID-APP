...
from keras.layers import Conv2D, AveragePooling2D, Activation, Dropout
...
model.fit(X_train,y_train,batch_size=8,epochs=50,validation_data=(X_test,y_test), callbacks=[early_stopping])
